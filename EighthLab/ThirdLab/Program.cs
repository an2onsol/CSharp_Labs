...
namespace ThirdLab {
    class Program {
        static void Main(string[] args) {
            ...
            MeatFactory Omkk = new MeatFactory("ул. Пушкина", 1000, DateTime.Now, 3, 15, TypesOfBuilding.Industrial, "Me", 12000, 12312312, 10, 200, 5);
            Omkk.IsWorking += (status) => Console.WriteLine("Working Status: " + status);
